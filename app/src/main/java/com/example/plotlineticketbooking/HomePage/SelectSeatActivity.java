...
//        Log.d(TAG, "setSeats: "+t+"-"+seatsArrayList.size());
    ...
    private void setGridView() {
        seatSelectionAdapter=new SeatSelectionAdapter(seatsArrayList,this,bookedSeats,selectedEvents.get(0));
        seatsGridView.setAdapter(seatSelectionAdapter);

    }

    private void setRecyclerView() {
        selectedShowRecyclerAdapter = new SelectedShowRecyclerAdapter(SelectSeatActivity.this, selectedEvents);
